 ...
 * Return: 1 if c is in alphabetic form, 0 if not
 */
 ...
 * @s: the string hat will be converted
 * Return: 0 if no numbers are in the string, convert numbers if otherwise
 */
