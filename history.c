 ...
 *
 * Return: allocated the string containing the history file
 */
 ...
 * @info: parameter struct
 *
 * Return: histcount on pass, 0 if otherwise
 */
...
/**
 * renumber_history – renumbers history linked list after the changes
